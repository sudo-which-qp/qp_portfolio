import {Avatar, Box, Flex, Icon, IconButton, Link, Text, Menu, Portal} from "@chakra-ui/react";
                ...
                >
                    ...
                    >
                        ...
                        <Flex direction="row" align="center" gap="2">
                            <Link _focus={{outline: 'none', boxShadow: 'none'}} href="/"
                                    ...
                                    <Menu.Content>
                                        <Menu.Item value="new-txt">
                                            <Link _focus={{outline: 'none', boxShadow: 'none'}}
                                                  href="/files/Godsend_J_CV.pdf" download={true} target="_blank">
                                                Resume
                                            </Link>
                                        </Menu.Item>
                                        <Menu.Item value="new-txt">
                        ...
                        {/* Row for Nav */}
                        <Flex display={{base: "none", md: "flex"}} direction="row" align="center" gap="3"
                              paddingRight="3">
